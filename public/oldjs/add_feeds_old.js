...
function getFeed(name) {
  ...
  switch (name) {
    ...
    break;
     case "DNA_India":
        feed_url = 'http://www.dnaindia.com/syndication/rss,catID-0.xml';
        break;
         case "India_today":
        feed_url = 'http://indiatoday.feedsportal.com/c/33614/f/647966/index.rss?http://indiatoday.intoday.in/rss/article.jsp?sid=120';
        break;
    case "Indian_express":
    ...
    break;
    case "reddit":
    feed_url = 'http://www.reddit.com/.rss';
    break;
    case "empire_online":
