...
(function(win, doc) {
	'use strict';
	var apiKey = 'AIzaSyBccjc1pHRSKUFe7yM8ltVbYPy_wvXVgWE';
	var YTV = YTV || function(id, opts) {
		...
		var noop = function() {},
			...
			utils = {
				...
				lazyload: function() {
					$(".ytv-list-inner img.lazy").lazyload({
						container: $(".ytv-list-inner"),
						threshold : 200
					});
				}				
			},
						...
						utils.ajax.get(utils.endpoints.userInfo(), function(userInfo) {
							...
							for (i = 0; i < videos.length; i++) {
								if (videos[i].status.embeddable) {
									...
									list += '<div class="ytv-thumb"><div class="ytv-thumb-stroke"></div><span>' + (time) + '</span><img class="lazy" data-original="' + (video.thumb) + '"></div>';
